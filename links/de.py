...
# Domain Lists
d1 = ["https://guides.snowflake.com/guide/data_engineering_with_dbt/index.html?index=..%2F..index#0",
     "https://guides.snowflake.com/guide/auto_ingest_twitter_data/index.html?index=..%2F..index#0",
     "https://guides.snowflake.com/guide/vhol_fivetran/index.html?index=..%2F..index#0",
     "https://www.snowflake.com/blog/support-for-calling-external-functions-via-google-cloud-api-gateway-now-in-public-preview/",
     "https://www.snowflake.com/blog/snowflake-spark-part-2-pushing-query-processing/",
...
d2 = ["https://guides.snowflake.com/guide/resource_optimization_performance_optimization/index.html?index=..%2F..index#0",
     "https://guides.snowflake.com/guide/resource_optimization_usage_monitoring/index.html?index=..%2F..index#0",
     "https://guides.snowflake.com/guide/data_app/index.html?index=..%2F..index#0",
     "https://community.snowflake.com/s/article/Performance-impact-from-local-and-remote-disk-spilling",
     "https://community.snowflake.com/s/article/Snowflake-Visualizing-Warehouse-Performance",
...
d3 = ["https://guides.snowflake.com/guide/getting_started_with_time_travel/index.html?index=..%2F..index#0",
     "https://docs.snowflake.com/en/user-guide/data-availability.html",
     "https://docs.snowflake.com/en/user-guide/databases.html",
     "https://docs.snowflake.com/en/sql-reference/parameters.html#parameter-hierarchy-and-types",
     "https://docs.snowflake.com/en/user-guide/database-replication-failover.html",
...
d4 = ["https://community.snowflake.com/s/article/snowflake-rbac-security-prefers-role-inheritance-to-role-composition",
     "https://docs.snowflake.com/en/user-guide-admin-security.html",
     "https://docs.snowflake.com/en/user-guide/ui-preferences.html",
     "https://docs.snowflake.com/en/user-guide-admin-governance.html",
     "https://docs.snowflake.com/en/sql-reference/stored-procedures.html",
...
d5 = ["https://resources.snowflake.com/data-engineering-2/snowflake-for-data-engineering-easily-ingest-transform-and-deliver-data-for-up-to-the-moment-insight",
     "https://www.snowflake.com/blog/bringing-extensibility-to-data-pipelines-whats-new-with-snowflake-external-functions/",
     "https://community.snowflake.com/s/article/Generating-a-JSON-Dataset-using-Relational-Data-in-Snowflake",
     "https://resources.snowflake.com/data-engineering/best-practices-for-managing-unstructured-data",
     "https://docs.snowflake.com/en/sql-reference/user-defined-functions.html",
...
# Data Engineer Dictionary
dict = {"": "",
        "Data Movement": d1,
        "Performance Optimization": d2, 
        "Storage and Data Protection": d3,
        "Security": d4,
        "Data Transformation": d5}